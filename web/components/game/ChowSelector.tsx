  ...
  return (
    <div className="space-y-1 md:space-y-2 py-1 md:py-2 px-1 md:px-2">
      <div className="text-center mb-1">
        <p className="font-display text-[10px] md:text-xs text-info">
          Choose your Chow:
        </p>
        <p className="font-sans text-[10px] text-muted-foreground mt-0.5 px-2">
        ...
        {options.map((handTiles, i) => {
          ...
          return (
            <button
              key={i}
              type="button"
              className="flex items-center gap-0.5 px-2 md:px-3 py-1 md:py-1.5 rounded border-2 border-border/40 hover:border-info/60 hover:bg-info/10 transition-colors min-h-[44px]"
