  ...
  lessons: [
    ...
    // LESSON 3: All Chows Hand
    {
      ...
      content: [
        ...
        "• Pair of 5-Bamboo",
        "",
        "All Chows just needs 4 chows + 1 pair — nothing else restricts it.",
        "The pair can be any tile (including honors), the hand can be",
        "concealed or exposed, and it scores the same whether you self-draw",
        "or win by discard.",
        "",
