  ...
  lessons: [
    // ---------------------------------------------------------------
    {
      ...
      content: [
        ...
        "",
        "That is the only reason the count matters: 14 is the shape of a finished hand, 13 is a hand waiting for one.",
        "",
        "PLAY PASSES TO YOUR RIGHT",
        "After you discard, the turn moves to the next seat and goes around the table the same direction all game.",
        "",
        "Nothing here is a decision yet. The decisions start when someone discards a tile you want — which is the rest of this level."
      ],
      keyTakeaways: [
    ...
    // ---------------------------------------------------------------
    {
      ...
      content: [
        ...
        "",
        "At the start of a hand all 144 tiles are shuffled and stacked. Each player is dealt 13. What's left is the wall, and it is drawn from, one tile at a time, for the rest of the hand.",
        "",
        "THE WALL IS FINITE",
        "This is the part new players miss. The wall is not endless. Every draw spends it, and a hand has a hard time limit measured in tiles.",
        "",
        ...
        "who are.",
        "",
        "Tenpai means you are one tile away from winning. Noten means you are not.",
        "",
        "If everyone is tenpai, or nobody is, nothing changes hands.",
        "",
        "The practical lesson: as the wall gets low, a hand that cannot win is worth steering toward tenpai anyway. Being one tile short pays. Being three tiles short costs."
      ],
      keyTakeaways: [
    ...
    // ---------------------------------------------------------------
    {
      ...
      content: [
        ...
        "The set becomes EXPOSED. You lay it face-up on the table and it stays there for the rest of the hand.",
        "",
        "That costs you two things:",
        "",
        "1. INFORMATION. Everyone can now see part of your hand. A player who sees you expose two bamboo sets will stop discarding bamboo.",
        "",
        "2. VALUE. Many of the better scoring hands require a fully concealed hand. One claim can close those doors permanently.",
        "",
        "So the real question is never 'can I claim this?' — it is 'is this tile worth showing my hand for?'",
        "",
        ...
        "",
        "The next three lessons are the rules that decide WHICH claims are legal and WHO gets the tile when more than one player wants it."
      ],
      tiles: ["bamboo-3", "bamboo-3", "bamboo-3", "dot-7", "dot-8", "dot-9"],
      keyTakeaways: [
        "A discard can be claimed by any player the claim is legal for — and not only on your turn.",
    ...
    // ---------------------------------------------------------------
    {
      ...
      content: [
        ...
        "If any player at the table discards a tile you hold two of, you can pung it. Three of, you can kong it. It does not matter who discarded.",
        "",
        "CHOW — FROM ONE PLAYER ONLY",
        "You can only chow from the player who plays immediately before you.",
        "",
        "That is the player on your LEFT — the one whose discard you see right before your own turn starts.",
        "",
        "If anyone else discards the exact tile that completes your run, you cannot take it. You watch it go.",
        "",
        "WHY THIS RULE EXISTS",
        "Think about what a chow does to the turn order. A pung or kong is rare enough that jumping the queue for one is fine. But runs are common — if you could chow from anyone, the turn order would barely survive first contact.",
        "",
        "Restricting chow to the player right before you means the tile was about to reach you anyway. You are taking your own turn slightly early, not stealing someone else's.",
        "",
        "WHAT THIS MEANS IN PLAY",
        "The player to your left is your supply line. Watch what they discard more closely than anyone else's — for runs, they are your only source besides the wall.",
        "",
        "And in the other direction: the player to your RIGHT can chow from you. If they are visibly collecting dots, think twice before feeding them a dot.",
        "",
        "One more restriction: chow only works on suit tiles — bamboo, characters, dots. Winds and dragons have no sequence, so there is nothing to run."
      ],
    ...
    // ---------------------------------------------------------------
    {
      ...
      content: [
        ...
        "WIN  >  KONG  >  PUNG  >  CHOW",
        "",
        "A player claiming to win beats a player claiming a kong. A kong beats a pung. A pung beats a chow. Always, regardless of seat.",
        "",
        "WHY THIS ORDER",
        "It runs from most decisive to least. A win ends the hand — nothing should outrank it. A chow is the cheapest and most common claim, so it sits at the bottom.",
        "",
        "Notice what this means for chow: it loses to everything. Your chow is the claim most likely to be taken out from under you.",
        "",
        "WHEN TWO PLAYERS MAKE THE SAME CLAIM",
        "Two players both want to pung the same tile. Priority is equal, so it cannot break the tie.",
        "",
        "The tile goes to whichever of them is CLOSEST TO THE DISCARDER in turn order — the one who would have played soonest anyway.",
        "",
        "This is the same principle as the chow rule. When the game has to pick, it picks the player the tile was already heading toward. Turn order is the tie-breaker for everything.",
        "",
        "WHAT TO DO WITH THIS",
        "Do not count on a chow. If a tile you want is also a plausible pung for someone else, assume you will lose it and have a second plan.",
        "",
        "And when you hold a pair of something conspicuous — dragons, the round wind — remember other players may be sitting on the same pair. Closest seat wins, and you may not be it."
      ],
      keyTakeaways: [
    ...
    // ---------------------------------------------------------------
    {
      ...
      content: [
        "This is the part that confuses new players more than any other rule, because nothing announces it. You just quietly lose a turn.",
        "",
        "WHEN A CLAIM JUMPS THE QUEUE",
        "Normally, after a discard, play moves to the very next seat.",
        "",
        "But when a player claims a discard, play jumps straight to THEM. They take the tile, expose the set, and discard.",
        "",
        ...
        "",
        "B and C are skipped. Neither one drew a tile. From B's point of view, their turn simply never arrived.",
        "",
        ...
        "",
        "1. Do not plan on a fixed number of remaining turns. You do not control how many you get.",
        "",
        "2. Late in a hand, a claim by a player downstream of you can end your hand's realistic chances without you ever getting to act again."
      ],
      keyTakeaways: [
    ...
    // ---------------------------------------------------------------
    {
      ...
      content: [
        "A game is not one hand. It is a sequence of them, and your seat changes as they go.",
        "",
        "THE DEALER IS EAST",
        ...
        "",
        "That is your SEAT WIND, and it is worth real points: completing a set of your own seat wind scores, where a set of some unrelated wind does not.",
        "",
        "So East, South, West and North are not decorations. Which wind is valuable to you changes hand to hand as the dealership moves.",
        "",
        "WHEN THE DEALER CHANGES",
        "Here is the rule, and note the second half — it is the part that surprises people:",
        "",
        "The dealer KEEPS the deal if they win the hand.",
        "The dealer ALSO keeps the deal if the hand ends in a draw.",
        "",
        "Otherwise — any other player wins — the dealership passes on, and everyone's seat wind shifts with it.",
        "",
        "A dealer on a run can hold the deal for several hands. A drawn hand changes nothing about who deals next.",
        "",
        "THE PREVAILING WIND",
        "There is a second wind in play: the ROUND wind, shared by everyone.",
        "",
        "A full game runs East round, then South, West and North. Each round lasts until the dealership has gone all the way around the table.",
        "",
        "A set of the current round's wind scores for ANY player. So in an East round, East tiles are valuable to everyone — which is exactly why they are dangerous to discard.",
        "",
        "A quick game is the East round only.",
        "",
        "PUTTING IT TOGETHER",
        "At any moment two winds matter to you: your seat wind, and the round wind. If you are East seat in the East round, East tiles are doubly worth collecting — and everyone else knows you want them."
      ],
    ...
    // ---------------------------------------------------------------
    {
      ...
      content: [
        ...
        "",
        "THE DEAL",
        "You are dealt 13 tiles. They are a mess — a pair of 3 bamboo, a loose 7 and 8 dot, three unconnected winds, and assorted junk.",
        "",
        "This is normal. Nobody is dealt a good hand.",
        "",
        "TURN 1 — YOU",
        "As dealer you go first. You draw: a red dragon. Nothing yet, but dragons score, so it is worth holding briefly.",
        "",
        "You discard a lone 2 character. Early discards should be your most isolated tiles, and that is the loneliest thing you have.",
        "",
        ...
        "",
        "No. Chow is legal only from the player immediately before you, and this is the player immediately AFTER you. You watch it go.",
        "",
        "This is the rule from lesson 7-4, and it costs you a tile within the first minute of a real hand.",
        "",
        "TURNS 3-4",
        "Play continues around. The player before you discards a 3 bamboo.",
        "",
        "You hold a pair of them. You pung — legal from anyone — and lay the three tiles face-up.",
        "",
        "You have gained: a completed set, immediately.",
        "You have lost: concealment. Everyone now knows you collect bamboo.",
        "",
        "Because you claimed, play jumps to YOU. The player who would have gone next is skipped — lesson 7-6, and they lose a draw for it.",
        "",
        "MIDGAME",
        "You discard, play resumes. Over several turns you draw into a second run in dots and pick up a third bamboo set.",
        "",
        "Now you hold three sets, a partial fourth, and your pair. One tile from a complete hand. You are TENPAI.",
        "",
        "THE FINISH",
        "The wall is getting low. Two things can happen.",
        "",
        "EITHER you draw your tile, complete the hand, and — assuming it is worth the minimum fan — win on a self-draw.",
        "",
        "OR a player discards it. If your hand meets the minimum, you claim to win — and remember from lesson 7-5 that a win claim outranks everything, so nobody can take that tile out from under you.",
        "",
        "IF NEITHER HAPPENS",
        "The wall runs out. The hand is a draw. You were tenpai, so you collect from the players who were not — and because a draw retains the deal, you are still East for the next hand.",
        "",
        "THAT IS A HAND",
        "Draw one, discard one, around the table. Claim when the tile is worth showing your hand for. Watch the player on your left, because they are your only source of runs. Count on nothing, because claims will take your turns away.",
        "",
        "Go and play one."
      ],
