  ...
  lessons: [
    ...
    // ---------------------------------------------------------------
    {
      ...
      content: [
        ...
        "",
        "OR a player discards it. You claim to win — and remember from lesson 7-5 that a win claim outranks everything, so nobody can take that tile out from under you.",
        "",
        "IF NEITHER HAPPENS",
