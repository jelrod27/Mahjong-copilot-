  ...
  theme: {
    extend: {
      colors: {
        ...
        surface: withAlpha(30, 31, 34),
        elevated: withAlpha(61, 62, 61),
        muted: withAlpha(32, 34, 36),
        "muted-foreground": withAlpha(168, 155, 140),
        card: withAlpha(37, 38, 40),
        "card-foreground": withAlpha(232, 223, 208),
        popover: withAlpha(86, 85, 82),
        "popover-foreground": withAlpha(232, 223, 208),
        border: "rgb(255 248 225 / 0.14)",
